...
//dark mode light mode #050A30 #0e1550
let check = true;
...
btn.addEventListener("click", () => {
    if (check) {
        ...
        document.querySelector(".left-part").style.backgroundColor = "#050A30";
        ...
        document.querySelector(".right-part").style.backgroundColor = "#0e1550";
        ...
        document.querySelector("body").style.backgroundColor = "#d0cccc";
        document.querySelector(".left-part").style.backgroundColor = "white";
        const div1 = document.querySelectorAll(".days div");
        const div2 = document.querySelectorAll(".highlights div");
        div1.forEach(div => {
        ...
        document.querySelector(".right-part").style.backgroundColor = "#eeeded";
